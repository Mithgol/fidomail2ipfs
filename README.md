...
This module is written in JavaScript and requires [Node.js](http://nodejs.org/) to run. It uses [`Buffer.from`](https://nodejs.org/docs/latest/api/buffer.html#buffer_class_method_buffer_from_string_encoding), and thus a relatively recent Node.js (v5.10.0 or newer) is required. This module is tested against the latest stable version of Node.js.
